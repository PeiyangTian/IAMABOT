...
- **Positioning (press).** When enemy fighters exist, every battle bot closes on its
  nearest one and stands to shoot once inside six tiles, so all guns engage at once and
  converge on the enemy's nearest bodies. Bots stay one splash diameter apart and off solid
...
- **Economy.** A balanced opening (3 extractors, 9 battle bots, 5 healers) starts the economy
